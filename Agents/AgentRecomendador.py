...
# Datos del Agente
AgentRecomendador = Agent('AgentRecomendador',
                      agn.AgentRecomendador,
...
def register_message():
    ...
    gr = register_agent(AgentRecomendador, DirectoryAgent, AgentRecomendador.uri, get_count())
    return gr
...
def comunicacion():
    ...
    if msgdic is None:
        ...
        gr = build_message(Graph(), ACL['not-understood'], sender=AgentRecomendador.uri, msgcnt=mss_cnt)
    else:
